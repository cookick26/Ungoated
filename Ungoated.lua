...
Frame.Size = UDim2.new(0, 220, 0, 540)
...
AimKeyLabel.Position = UDim2.new(0, 10, 0, 290)
AimKeyLabel.Text = "AIM KEY : " .. tostring(Settings.AimKey)
...
AimKeyButton.Size = UDim2.new(0.5, -12, 0, 22)
AimKeyButton.Position = UDim2.new(0, 10, 0, 312)
AimKeyButton.BackgroundColor3 = Color3.fromRGB(105, 12, 12)
AimKeyButton.Text = "P KEY"
...
local AimKeyButton2 = Instance.new("TextButton")
AimKeyButton2.Size = UDim2.new(0.5, -12, 0, 22)
AimKeyButton2.Position = UDim2.new(0.5, 2, 0, 312)
AimKeyButton2.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
AimKeyButton2.Text = "RIGHT CLICK"
AimKeyButton2.TextColor3 = Color3.fromRGB(255, 255, 255)
AimKeyButton2.Font = Enum.Font.SourceSansBold
AimKeyButton2.TextSize = 12
AimKeyButton2.Parent = Frame

AimKeyButton.MouseButton1Click:Connect(function()
  Settings.AimKey = Enum.KeyCode.P
  AimKeyLabel.Text = "AIM KEY : P"
  AimKeyButton.Text = "P KEY"
  AimKeyButton.BackgroundColor3 = Color3.fromRGB(105, 12, 12)
  AimKeyButton2.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
end)

local AimKeyButtonCorner2 = Instance.new("UICorner")
AimKeyButtonCorner2.CornerRadius = UDim.new(0, 5)
AimKeyButtonCorner2.Parent = AimKeyButton2

AimKeyButton2.MouseButton1Click:Connect(function()
  Settings.AimKey = Enum.UserInputType.MouseButton2
  AimKeyLabel.Text = "AIM KEY : RIGHT CLICK"
  AimKeyButton2.Text = "RIGHT CLICK"
  AimKeyButton2.BackgroundColor3 = Color3.fromRGB(105, 12, 12)
  AimKeyButton.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
end)

-- 체크박스 4개
createCheckbox("Show Name", Settings.ShowESPName, 350, function(val)
  Settings.ShowESPName = val
end)

createCheckbox("Show Box", Settings.ShowESPBox, 388, function(val)
  Settings.ShowESPBox = val
end)

createCheckbox("Show Health", Settings.ShowESPHealth, 426, function(val)
  Settings.ShowESPHealth = val
end)

createCheckbox("Show Distance", Settings.ShowESPDistance, 464, function(val)
...
RunService.RenderStepped:Connect(function()
  ...
  elseif typeof(Settings.AimKey) == "EnumItem" and Settings.AimKey.EnumType == Enum.UserInputType then
      shouldAim = UserInputService:IsMouseButtonPressed(Settings.AimKey)
  end
